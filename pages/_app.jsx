      ...
      <section className="pt-32 pb-16 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="relative inline-block mb-8">
            <img src="/img/logo.png" alt="Pogo Avatar" className="w-40 h-40 md:w-52 md:h-52 rounded-full object-cover border-4 border-[#4F4CE5] shadow-lg" />
            <div className="absolute -top-2 -right-2 bg-gradient-to-r from-[#4F4CE5] to-[#8482FB] p-3 rounded-full flex items-center justify-center w-10 h-10">
