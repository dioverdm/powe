...
const ErrorPage = ({ code, message }) => {
    ...
    return <>
        <Head>
            <title>{code} | Pogo OS Bot de Discord Multipropósito</title>
        </Head>
      ...
      <img width="400" src="/img/bck3.png" />
            ...
            >
                {clicked ? <i className="fad fa-spinner-third fa-spin text-white" /> : <><i className='fa fa-arrow-left mr-2' />Volver atrás</>}
            </button>
        </div>
    </>
}
